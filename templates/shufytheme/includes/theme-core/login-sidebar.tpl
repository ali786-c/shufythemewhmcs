<div class="login__register__sidebar d-lg-flex d-none">
	...
	<div class="website__identity__sidebar d-flex align-items-center justify-content-start mb-8">		
		<a class="website__identity__sidebar__link text-center d-flex align-items-center justify-content-start gap-10" href="{if $coodivsettings.customlogolink}{$coodivsettings.customlogolink}{else}{$WEB_ROOT}/index.php{/if}">
