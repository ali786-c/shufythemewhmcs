										...
										<div class="item__grid col-md-4 col-6">
											<div class="radio__check__panel default__shadow__panel">
												<div class="default__shadow__panel__body__small">
													<label class="radio cart__choose__cycle__label d-flex flex-column align-items-center justify-content-center text-center {if $billingcycle eq "monthly"} checked{/if}" for="monthly" {if $configurableoptions}data-update-config data-config-i={$i} data-config-val="monthly"{else}data-change-billingcycle{/if}>
														<div class="cart__choose__cycle__content text-center mb-3">
															<h6 class="coodiv-text-10">{$LANG.orderpaymenttermmonthly}</h6>
															<p class="coodiv-text-6 main-text-color font-weight-bold mb-0">{$currency.prefix}{$pricing.rawpricing.monthly|number_format:2:'.':','}{$currency.suffix}</p>
										...
										<div class="item__grid col-md-4 col-6">
											<div class="radio__check__panel default__shadow__panel">
												<div class="default__shadow__panel__body__small">
													...
													<label class="cart__choose__cycle__label d-flex flex-column align-items-center justify-content-center text-center" for="quarterly" {if $configurableoptions}data-update-config data-config-i={$i} data-config-val="quarterly"{else}data-change-billingcycle{/if}>
														<div class="cart__choose__cycle__content text-center mb-3">
															...
															<p id="cyclepricequarterly" data-row-price="{$pricing.rawpricing.quarterly}" class="coodiv-text-6 main-text-color font-weight-bold mb-0">{$currency.prefix}{$pricing.rawpricing.quarterly|number_format:2:'.':','}{$currency.suffix}</p>
									...
									<div class="item__grid col-md-4 col-6">
										<div class="radio__check__panel default__shadow__panel">
											<div class="default__shadow__panel__body__small">
												...
												<label class="cart__choose__cycle__label d-flex flex-column align-items-center justify-content-center text-center" {if $configurableoptions}data-update-config data-config-i={$i} data-config-val="semiannually"{else}data-change-billingcycle{/if}>
													<div class="cart__choose__cycle__content text-center mb-3">
														...
														<p id="cyclepricesemiannually" data-row-price="{$pricing.rawpricing.semiannually}" class="coodiv-text-6 main-text-color font-weight-bold mb-0">{$currency.prefix}{$pricing.rawpricing.semiannually|number_format:2:'.':','}{$currency.suffix}</p>
									...
									<div class="radio__check__panel item__grid col-md-4 col-6">
										<div class="radio__check__panel default__shadow__panel">
											<div class="default__shadow__panel__body__small">
												...
												<label class="cart__choose__cycle__label d-flex flex-column align-items-center justify-content-center text-center" {if $configurableoptions}data-update-config data-config-i={$i} data-config-val="annually"{else}data-change-billingcycle{/if}>
													<div class="cart__choose__cycle__content text-center mb-3">
														...
														<p id="cyclepriceannually" data-row-price="{$pricing.rawpricing.annually}" class="coodiv-text-6 main-text-color font-weight-bold mb-0">{$currency.prefix}{$pricing.rawpricing.annually|number_format:2:'.':','}{$currency.suffix}</p>
									...
									<div class="radio__check__panel item__grid col-md-4 col-6">
										<div class="radio__check__panel default__shadow__panel">
											<div class="default__shadow__panel__body__small">
												...
												<label class="cart__choose__cycle__label d-flex flex-column align-items-center justify-content-center text-center" {if $configurableoptions}data-update-config data-config-i={$i} data-config-val="biennially"{else}data-change-billingcycle{/if}>
													<div class="cart__choose__cycle__content text-center mb-3">
														...
														<p id="cyclepricebiennially" data-row-price="{$pricing.rawpricing.biennially}" class="coodiv-text-6 main-text-color font-weight-bold mb-0">{$currency.prefix}{$pricing.rawpricing.biennially|number_format:2:'.':','}{$currency.suffix}</p>
									...
									<div class="radio__check__panel item__grid col-md-4 col-6">
										<div class="radio__check__panel default__shadow__panel">
											<div class="default__shadow__panel__body__small">
												...
												<label class="cart__choose__cycle__label d-flex flex-column align-items-center justify-content-center text-center" {if $configurableoptions}data-update-config data-config-i={$i} data-config-val="triennially"{else}data-change-billingcycle{/if}>
													<div class="cart__choose__cycle__content text-center mb-3">
														...
														<p id="cyclepricetriennially" data-row-price="{$pricing.rawpricing.triennially}" class="coodiv-text-6 main-text-color font-weight-bold mb-0">{$currency.prefix}{$pricing.rawpricing.triennially|number_format:2:'.':','}{$currency.suffix}</p>
